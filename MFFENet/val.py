...
from dataloaders.datasets import vaihingen
...
class Trainer(object):
    def __init__(self, args):
        ...
        val_set = vaihingen.Vaihingen(self.args, split='val')
        self.nclass = val_set.NUM_CLASSES
        self.val_loader = DataLoader(val_set, batch_size=args.batch_size, shuffle=False, drop_last=True, num_workers=args.workers, pin_memory=True)
        ...
        # optimizer = optim.Adam(train_params, betas=(0.9, 0.99))
    ...
    def validation(self, epoch):
        ...
        self.writer.add_scalar('val/F1_mean', F1_mean1, epoch)
        ...
        self.writer.add_scalar('val/F1_mean', mIoU1, epoch)
        ...
        print("F1[0]:{}, F1[1]:{}, F1[2]:{}, F1[3]: {}, F1[4]: {}, F1[5]: {}, F1_mean: {}, F1_mean1: {}".format(F1[0],
                                                                                                                F1[1],
                                                                                                                F1[2],
                                                                                                                F1[3],
                                                                                                                F1[4],
                                                                                                                ...
                                                                                                                F1_mean,
                                                                                                                F1_mean1))
        print("IoU[0]:{}, IoU[1]:{}, IoU[2]:{}, IoU[3]: {}, IoU[4]: {}, IoU[5]: {}, mIoU: {}, mIoU1: {}".format(IoU[0],
                                                                                                                IoU[1],
                                                                                                                IoU[2],
                                                                                                                IoU[3],
                                                                                                                IoU[4],
...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='vaihingen',
                        choices=['pascal', 'coco', 'cityscapes', 'vaihingen', 'potsdam'],
    ...
    parser.add_argument('--gpu-ids', type=str, default=True,
                        help='use which gpu to train, must be a \
                        comma-separated list of integers only (default=0,1)')
    parser.add_argument('--seed', type=int, default=1, metavar='S',
                        help='random seed (default: 1)')
    # checking point
    parser.add_argument('--resume', type=str, default='C:/Users/徐青松/Desktop/First_paper/MFFENet_paper/Model/model0108/Po/MFFENet/checkpoint.pth.tar',
