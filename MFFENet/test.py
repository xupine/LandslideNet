...
class DFPE_test(object):
    ...
    def vis_segmentation(self, seg_map, m):
        ...
        # images.save('C:\\Users\\徐青松\\Desktop\\First_paper\\MFFENet_paper\\Model\\model0108\\Landslide\\src\\MFFENet_0630\\images_diff_1_0_0.01.jpg')
        seg_image.save('E:\\WC\\0425\\MFFENet\\%d.png'% m)

model_path = 'E:\\WC\\0326\\MFFPNet_100_all\\model_best.pth.tar'
MODEL = DFPE_test(model_path)
# PATH_TO_TEST_IMAGES_DIR = 'C:\\Users\\徐青松\\Desktop\\First_paper\\MFFENet_paper\\Model_results\\Segmentation\\landslide_bhd'
# TEST_IMAGE_PATHS = os.path.join(PATH_TO_TEST_IMAGES_DIR, '11.tif')
# for i in range(1):
#     va = i * 0.01
#     img2 = Image.open(TEST_IMAGE_PATHS).convert('RGB')
...
for i in range(1,5):
    m = str(i)
    dataset = gdal.Open('E:\\WC\\0425\\'+ m + '.tif')
    print('E:\\WC\\0425\\'+ m + '.tif')
